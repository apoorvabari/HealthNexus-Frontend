...
export default function DoctorLoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.role && response.role.toUpperCase() !== "DOCTOR") {
        Toast.show({
          type: "error",
          text1: "Access Denied",
      ...
      Toast.show({
        type: "success",
        text1: "Doctor Login Successful",
        text2: response.message || "Welcome to Doctor Console!",
      });
      ...
      const message =
        ...
        error?.message ||
        "Unable to login to Doctor Portal.";
      Toast.show({
        type: "error",
        text1: "Login Failed",
        text2: message,
      ...
      >
        ...
        >
          ...
          <View style={styles.headerSection}>
            ...
            <Text style={styles.title}>Doctor Console Sign In</Text>
            <Text style={styles.subtitle}>
              Manage appointments, patient histories & clinical notes
            </Text>
          </View>
          ...
          <View style={styles.formCard}>
            ...
            <PrimaryButton
              title="Sign In to Doctor Console"
              onPress={handleLogin}
              loading={loading}
          ...
          <View style={styles.footerSection}>
            <TouchableOpacity onPress={() => router.push("/doctor/register")}>
              <Text style={styles.registerText}>
                New Doctor? <Text style={styles.registerBold}>Register Doctor Account</Text>
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
